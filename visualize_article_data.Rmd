...
We searched for four terms in the extracted text of articles, using MongoDB's text search capabilities. We think these terms will select articles which have a fieldwork component over those that don't. The terms used are: `["field work", "fieldwork", "field study", "study site"]`.
